...
//	final public static String DEFAULT_PATH_ATM = DEFAULT_PATH_CAMPAIGN+"/"+DEFAULT_CAMPAIGN_FOLDER+"/ATM";
	...
	final public static Integer BOARD_SIZE = 8;	
	final public static Integer POPULATION_SIZE = 2000;	
	final public static double MUTATION_RATE = 0.35;	
	final public static Integer TOTAL_GENERATION = 10000;
	
	
	
	final public static Integer MAX_POINT = (BOARD_SIZE*(BOARD_SIZE-1))/2;
...
//	private Value vPathFolderATM = new Value(DEFAULT_PATH_ATM);
...
//		hTable.put("PathFolderCAMPAIGN",vPathFolderCAMPAIGN);
//		hTable.put("FolderCAMPAIGN",vFolderCAMPAIGN);
//		hTable.put("PathFolderINP",vPathFolderINP);
